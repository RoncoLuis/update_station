...
ap.add_argument("-o", "--output", type=str, default="../ficheros_salidas/resultado.csv")
args = vars(ap.parse_args())

# Iniciando Stream (iniciar webcam)
...
# loop sobre el stream de la camara web
while True:
    ...
    # encontrar los códigos de barras y decodificarlos
